// The 54 African countries, matching the slugs used by the Africa map data
// (client/public/data/africa.json) and by healer country selection.
export const AFRICAN_COUNTRIES: { name: string; slug: string }[] = [
