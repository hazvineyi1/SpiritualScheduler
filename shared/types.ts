...
export const READINGS: Reading[] = [
  ...
  { id: 2, name: "The Friendship Spread", category: "love_relationships", price: 60, description: "Gain clarity on a friendship — its strengths, hidden tensions, and the spiritual bond you share.", formats: ["video","chat","async"], isAdult: false, isFixed: false },
  ...
  { id: 4, name: "Love Thermometer Spread", category: "love_relationships", price: 40, description: "Measure the current temperature of love in a specific connection and where it is heading.", formats: ["video","chat","async"], isAdult: false, isFixed: false },
  ...
  { id: 6, name: "Easy Relationship Spread", category: "love_relationships", price: 30, description: "A concise, accessible reading on the current energy of a relationship in your life.", formats: ["chat","async"], isAdult: false, isFixed: false },
  { id: 7, name: "Couples Spread", category: "love_relationships", price: 30, description: "A shared reading exploring the joint energy, blockages, and future of a couple.", formats: ["video","chat","async"], isAdult: false, isFixed: false },
  ...
  { id: 10, name: "Family Spread", category: "love_relationships", price: 60, description: "Explore the spiritual dynamics, ancestral tensions, and blessings within your family unit.", formats: ["video","chat","async"], isAdult: false, isFixed: false },
  { id: 11, name: "Red Hot Intimacy", category: "love_relationships", price: 120, description: "A frank, spiritual exploration of passion, intimacy, and sexual energy in a connection. Adults only.", formats: ["video","chat","async"], isAdult: true, isFixed: false },
  { id: 12, name: "Adult Spread", category: "love_relationships", price: 30, description: "An adult-only reading on mature themes in love and intimacy. 18+ only.", formats: ["chat","async"], isAdult: true, isFixed: false },
  { id: 13, name: "Before Getting A Couple Reading", category: "love_relationships", price: 150, description: "A prerequisite deep-dive 60-minute session preparing both partners spiritually for a joint reading.", formats: ["video"], isAdult: false, isFixed: true },

  // Ancestors & Spirit
  { id: 14, name: "Ancestor Reading", category: "ancestors_spirit", price: 70, description: "Connect with ancestral energies and receive their wisdom, warnings, and blessings for your life path.", formats: ["video","audio","async"], isAdult: false, isFixed: false, customIntake: [{ field: "ancestor", label: "Ancestor to connect with (name if known)" }] },
  { id: 15, name: "Connecting with a Passed Loved One", category: "ancestors_spirit", price: 50, description: "A sensitive mediumship reading to bridge the gap between you and a departed loved one.", formats: ["video","audio","async"], isAdult: false, isFixed: false, customIntake: [{ field: "lovedOne", label: "Passed loved one's name and your relationship to them" }] },
  { id: 16, name: "Hakata (Bone Throwing / Osteomancy)", category: "ancestors_spirit", price: 40, description: "A traditional Shona divination using Hakata bones, bridging the seen and unseen worlds to reveal truth.", formats: ["video","audio","async"], isAdult: false, isFixed: false },
  { id: 17, name: "Is A Spirit Contacting You?", category: "ancestors_spirit", price: 50, description: "Identify and understand spiritual presences, signs, and messages showing up in your daily life.", formats: ["video","audio","async"], isAdult: false, isFixed: false },
  { id: 18, name: "Mediumship Development", category: "ancestors_spirit", price: 50, description: "Guidance for those awakening to and developing their own mediumship gifts and spiritual sensitivity.", formats: ["video","audio","async"], isAdult: false, isFixed: false },

  // Healing & Wellbeing
  { id: 19, name: "Shadow Work Spread", category: "healing_wellbeing", price: 60, description: "Illuminate the hidden aspects of your psyche and receive guidance on deep integration and healing.", formats: ["video","chat","async"], isAdult: false, isFixed: false },
  ...
  { id: 22, name: "Spiritual Cleanse", category: "healing_wellbeing", price: 45, description: "A targeted reading and spiritual prescription for clearing negative energy from your aura and environment.", formats: ["video","audio","async"], isAdult: false, isFixed: false },
  { id: 23, name: "Bad Mood Spread", category: "healing_wellbeing", price: 20, description: "A quick, uplifting reading to shift your energy and understand the root of persistent low moods.", formats: ["chat","async"], isAdult: false, isFixed: false },

  // Spells & Protection
  { id: 24, name: "Leave Me Alone / Banishing Spell", category: "spells_protection", price: 100, description: "Remove an unwanted person or harmful energy from your life through ancestral spell work. Delivered asynchronously.", formats: ["async"], isAdult: false, isFixed: false, customIntake: [{ field: "target", label: "Who or what to remove (be as specific as possible)" }] },
  { id: 25, name: "Return To Sender Spell", category: "spells_protection", price: 100, description: "Send back negative energy, curses, or ill-will to its original source. Delivered asynchronously.", formats: ["async"], isAdult: false, isFixed: false, customIntake: [{ field: "target", label: "Who/what to send back (be specific)" }] },
  { id: 26, name: "Remove 3rd Party", category: "spells_protection", price: 100, description: "Spiritual work to remove a third-party interference from a relationship or situation. Delivered asynchronously.", formats: ["async"], isAdult: false, isFixed: false, customIntake: [{ field: "thirdParty", label: "Third party to remove (name if known)" }] },
  { id: 27, name: "Protected & Guarded", category: "spells_protection", price: 15, description: "A light but powerful protective blessing to shield your energy field from negativity and psychic harm.", formats: ["async"], isAdult: false, isFixed: false },
  ...
  { id: 30, name: "Find Out The Truth", category: "guidance_future", price: 40, description: "Seek the hidden truth in a situation, relationship, or decision where something feels unclear or concealed.", formats: ["video","chat","async"], isAdult: false, isFixed: false },
  { id: 31, name: "The Next Few Months", category: "guidance_future", price: 60, description: "A forward-looking reading on the energies, events, and turning points coming in the near future.", formats: ["video","audio","async"], isAdult: false, isFixed: false },
  { id: 32, name: "2026 New Year Spread", category: "guidance_future", price: 50, description: "Set powerful intentions for 2026 with ancestral guidance on the themes and opportunities of the year ahead.", formats: ["video","audio","async"], isAdult: false, isFixed: false },
  ...
  { id: 34, name: "Vision of Success Spread", category: "guidance_future", price: 40, description: "Clarify your soul's personal definition of success and the spiritual steps to manifest it.", formats: ["video","chat","async"], isAdult: false, isFixed: false },
  { id: 35, name: "Seeking Prosperity", category: "guidance_future", price: 60, description: "Open the doors of abundance, identify what is blocking your prosperity, and activate your wealth energy.", formats: ["video","audio","async"], isAdult: false, isFixed: false },
  { id: 36, name: "Dream Interpretation Spread", category: "guidance_future", price: 40, description: "Decode the spiritual messages and ancestral communications hidden within your dreams.", formats: ["audio","chat","async"], isAdult: false, isFixed: false, customIntake: [{ field: "dream", label: "Describe your dream in as much detail as possible" }] },
  { id: 37, name: "Connecting With Your Home", category: "guidance_future", price: 60, description: "Explore the spiritual energy of your home, ancestral land, and your soul's sense of belonging and rootedness.", formats: ["video","audio","async"], isAdult: false, isFixed: false },
  { id: 38, name: "Happy Birthday Spread", category: "guidance_future", price: 70, description: "A celebratory reading illuminating your soul's gifts, themes, and blessings for the year of your birth.", formats: ["video","audio","async"], isAdult: false, isFixed: false },

  // Live & In-Person
  { id: 39, name: "Unlimited Cards — 1 Hour Video", category: "live_in_person", price: 120, description: "A full 60-minute unrestricted tarot and oracle card reading via video — ask everything on your mind.", formats: ["video"], isAdult: false, isFixed: true },
  { id: 40, name: "Couple Reading (Video)", category: "live_in_person", price: 120, description: "A joint 60-minute video session for couples seeking spiritual clarity, healing, and guidance together.", formats: ["video"], isAdult: false, isFixed: true },
